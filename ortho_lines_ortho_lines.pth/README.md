...
- **תאריך הורדה**: Thu Nov 20 12:24:38 UTC 2025
...
cd model-mirror
git sparse-checkout set ortho_lines_ortho_lines.pth

# איחוד
cd ortho_lines_ortho_lines.pth
python merge.py
```
...
```bash
# הורדת כל החלקים
BASE_URL="https://raw.githubusercontent.com/sumca1/model-mirror/main/ortho_lines_ortho_lines.pth"
